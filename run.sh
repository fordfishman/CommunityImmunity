...
settings=${sims}sims_t${t}_a${a}_adsp${adsp}_b${b}_beta${beta}_d${d}_l${l}_m${m}_pS${pS}
...
time python3 $python/main.py -s True -t $t -o $output -pS $pS -a $a -b $b -l $l -m $m -d $d --adsp $adsp --beta $beta
